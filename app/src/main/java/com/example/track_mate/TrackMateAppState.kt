...
import com.example.track_mate.common.snackbar.SnackbarMessage.Companion.toMessage
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.flow.filterNotNull
import kotlinx.coroutines.launch

@Stable
class TrackMateAppState(
    ...
    init {
        coroutineScope.launch {
            snackbarManager.snackbarMessages.filterNotNull().collect { snackbarMessage ->
                ...
                // scaffoldState.snackbarHostState.showSnackbar(text) // TODO: It can be problem
                snackbarManager.showMessage(text)
                // Remove the message from the state
                snackbarManager.dismissMessage()
            }
        }
    }
