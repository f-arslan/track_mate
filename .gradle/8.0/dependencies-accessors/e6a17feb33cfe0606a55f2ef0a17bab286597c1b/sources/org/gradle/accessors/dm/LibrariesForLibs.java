...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class HiltLibraryAccessors extends SubDependencyFactory {
        ...
        public HiltLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for version (com.google.dagger:hilt-android)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getVersion() { return create("hilt.version"); }
    ...
    public static class HiltVersionAccessors extends VersionFactory  {
        ...
        public HiltVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: hilt.version (2.44)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class HiltPluginAccessors extends PluginFactory {
        ...
        public HiltPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for hilt.version to the plugin id 'com.google.dagger.hilt.android'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getVersion() { return createPlugin("hilt.version"); }
