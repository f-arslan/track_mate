...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final VindowLibraryAccessors laccForVindowLibraryAccessors = new VindowLibraryAccessors(owner);
    ...
    public LibrariesForLibs(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
         ...
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getViewModel() { return create("viewModel"); }
    ...
    /**
     * Returns the group of libraries at vindow
     */
    public VindowLibraryAccessors getVindow() { return laccForVindowLibraryAccessors; }
    ...
    public static class VindowLibraryAccessors extends SubDependencyFactory {
        private final VindowSizeLibraryAccessors laccForVindowSizeLibraryAccessors = new VindowSizeLibraryAccessors(owner);

        public VindowLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at vindow.size
         */
        public VindowSizeLibraryAccessors getSize() { return laccForVindowSizeLibraryAccessors; }

    }

    public static class VindowSizeLibraryAccessors extends SubDependencyFactory {

        public VindowSizeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for class (androidx.compose.material3:material3-window-size-class)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getClass() { return create("vindow.size.class"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final WindowVersionAccessors vaccForWindowVersionAccessors = new WindowVersionAccessors(providers, config);
        ...
        /**
         * Returns the group of versions at versions.window
         */
        public WindowVersionAccessors getWindow() { return vaccForWindowVersionAccessors; }
    ...
    public static class CoreVersionAccessors extends VersionFactory  {
        ...
        public CoreVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: core.ktx (1.10.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class WindowVersionAccessors extends VersionFactory  {

        private final WindowSizeVersionAccessors vaccForWindowSizeVersionAccessors = new WindowSizeVersionAccessors(providers, config);
        public WindowVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of versions at versions.window.size
         */
        public WindowSizeVersionAccessors getSize() { return vaccForWindowSizeVersionAccessors; }

    }

    public static class WindowSizeVersionAccessors extends VersionFactory  {

        public WindowSizeVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: window.size.class (1.0.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getClass() { return getVersion("window.size.class"); }
