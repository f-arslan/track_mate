...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final WindowLibraryAccessors laccForWindowLibraryAccessors = new WindowLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at window
     */
    public WindowLibraryAccessors getWindow() { return laccForWindowLibraryAccessors; }
    ...
    public static class WindowLibraryAccessors extends SubDependencyFactory {
        private final WindowSizeLibraryAccessors laccForWindowSizeLibraryAccessors = new WindowSizeLibraryAccessors(owner);

        public WindowLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at window.size
         */
        public WindowSizeLibraryAccessors getSize() { return laccForWindowSizeLibraryAccessors; }

    }

    public static class WindowSizeLibraryAccessors extends SubDependencyFactory {

        public WindowSizeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for class (androidx.compose.material3:material3-window-size-class)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getClass() { return create("window.size.class"); }
